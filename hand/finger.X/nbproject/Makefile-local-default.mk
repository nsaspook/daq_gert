...
#
PATH_TO_IDE_BIN=/opt/microchip/mplabx/v3.51/mplab_ide/platform/../mplab_ide/modules/../../bin/
# Adding MPLAB X bin directory to path.
PATH:=/opt/microchip/mplabx/v3.51/mplab_ide/platform/../mplab_ide/modules/../../bin/:$(PATH)
# Path to java used to run MPLAB X when this makefile was created
MP_JAVA_PATH="/opt/microchip/mplabx/v3.51/sys/java/jre1.8.0_91/bin/"
...
DEP_GEN=${MP_JAVA_PATH}java -jar "/opt/microchip/mplabx/v3.51/mplab_ide/platform/../mplab_ide/modules/../../bin/extractobjectdependencies.jar"
